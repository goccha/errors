...
func TestFrameFormat(t *testing.T) {
	var tests = []struct {
		...
		initpc,
		"%+v",
		" at github.com/goccha/errors.init (" +
...
func TestStackTrace(t *testing.T) {
	tests := []struct {
		...
		New("ooh"), []string{
			" at github.com/goccha/errors.TestStackTrace (" +
		...
		func() error { return New("ooh") }(), []string{
			` at github.com/goccha/errors.TestStackTrace.func1 (` +
		...
		Cause(func() error {
			...
			` at github.com/goccha/errors.TestStackTrace.func2.1 (` +
				".+/errors/stack_test.go:145)", // this is the stack of Errorf
			` at github.com/goccha/errors.TestStackTrace.func2 (` +
...
func TestStackTraceFormat(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"\n" +
			" at github.com/goccha/errors.stackTrace (" +
			".+/errors/stack_test.go:174)\n" +
			" at github.com/goccha/errors.TestStackTraceFormat (" +
